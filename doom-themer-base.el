;;; doom-themer-base.el --- Base themes for others to extend -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
...
(define-doom-theme (doom-base-dark :base t)
  "TODO"
  ;;; palette
  ((bg "black")
   (bg-alt "dim black")
   ...
   ;; highlights
   (cursor "white")
   (highlight-line "dim grey")
   (highlight-primary "skyblue")
   (highlight-secondary "chartreuse")
   (selection-primary "dim grey")
   (selection-secondary "grey")
   ;; syntax
   (builtin "blue")
   (comments "dim grey")
   ;;constants
   (doc-comments "dim green")
   ;;functions
   ;;keywords
   ;;links
   ;;methods
   ...
   (panel-bg "#333333")
   (panel-fg "#bbbbbb")
   (panel-inactive-bg "#111111")
   (panel-inactive-fg "#777777")
   (panel-highlight-1 "blue")
   (panel-highlight-2 "green")
   (panel-highlight-3 "red")
   (tooltip-bg (lighten bg 0.15))
   (tooltip-fg fg)
   )
  ...
  ((bold                 :weight 'bold)
   ...
   (default              :bg bg :fg fg)
   (fringe               :inherit 'default :fg panel-inactive-fg)
   (region               :bg selection-primary :fg nil :dfg (darken fg 0.2))
   (highlight            :bg highlight-primary :fg bg :dfg fg-alt)
   (cursor               :bg highlight-primary)
   ;; (shadow               :foreground base5)
   (minibuffer-prompt    :fg highlight-primary)
   ...
   (trailing-whitespace  :bg warning)
   ;; (nobreak-space        :inherit 'default :underline nil)
   (vertical-border      :bg border :fg border)
   (link                 :fg highlight-primary :underline t :weight 'bold)
   (hl-line :bg bg-alt)
   ...
   ;; 2. All other line number plugin faces should &extend from these.
   ...
   ;; (avy-lead-face-0 :inherit 'avy-lead-face :background (doom-lighten highlight 0.3))
   ;; (avy-lead-face-1 :inherit 'avy-lead-face :background (doom-lighten highlight 0.6))
   ;; (avy-lead-face-2 :inherit 'avy-lead-face :background (doom-lighten highlight 0.9))
   ...
   ;; ;; diff-hl
   ;; (diff-hl-change :foreground modified)
   ;; (diff-hl-delete :foreground deleted)
   ;; (diff-hl-insert :foreground added)

   ;; ;; diff-mode
   ;; (diff-added   :inherit 'hl-line :foreground green)
   ;; (diff-changed :foreground violet)
   ;; (diff-context :foreground (doom-darken fg 0.12))
   ...
   ;; (git-gutter:added    :foreground added)
   ;; (git-gutter:deleted  :foreground deleted)

   ;; ;; git-gutter+
   ;; (git-gutter+-modified :foreground cyan :background nil)
   ;; (git-gutter+-added    :foreground added :background nil)
   ;; (git-gutter+-deleted  :foreground deleted :background nil)

   ;; ;; git-gutter-fringe
   ;; ((git-gutter-fr:modified &extend git-gutter:modified))
   ;; ((git-gutter-fr:added    &extend git-gutter:added))
   ;; ((git-gutter-fr:deleted  &extend git-gutter:deleted))
   ...
   ;; ;; helm
   ;; (helm-selection :inherit 'bold :background selection :distant-foreground highlight)
   ...
   ;; ;; indent-guide
   ;; ((indent-guide-face &extend highlight-indentation-face))
   ...
   ;; (ivy-modified-buffer :inherit 'bold :foreground modified)
   ...
   ;; ;; linum-relative
   ;; ((linum-relative-current-face &extend line-number-current-line))
   ...
   ;; (neo-added-face   :foreground green)
   ...
   ;; ;; nlinum
   ;; ((nlinum-current-line &extend line-number-current-line))

   ;; ;; nlinum-hl
   ;; ((nlinum-hl-face &extend line-number-current-line))

   ;; ;; nlinum-relative
   ;; ((nlinum-relative-current-face &extend line-number-current-line))
   ...
   ;; (lsp-ui-peek-header :foreground fg :background (doom-lighten bg 0.1) :weight 'bold)
   ;; (lsp-ui-peek-selection :foreground bg :background blue :weight 'bold)
   ...
   ;; ;; show-paren
   ;; ((show-paren-match &extend paren-face-match))
   ;; ((show-paren-mismatch &extend paren-face-mismatch))

   ;; ;; smartparens
   ;; (sp-pair-overlay-face :background region)

   ;; ;; smartparens
   ;; ((sp-show-pair-match-face    &extend show-paren-match))
   ;; ((sp-show-pair-mismatch-face &extend show-paren-mismatch))
   ...
   ;; ((smerge-mine  &extend smerge-upper))
   ;; ((smerge-other &extend smerge-lower))
   ...
   ;; (spaceline-modified :background modified)
   ...
   ;; ;; twittering-mode
   ;; (twitter-divider :underline `(:color ,(doom-darken border 0.2))) ; custom face in Doom Emacs
...
;; (define-doom-theme doom-base-dark
;;   "TODO"

;;   ;;; Palette    24-bi     256       16
;;   (((bg         '("#222222" nil       nil))
;;     (bg-alt     '("#444444" nil       nil))
;;     (fg         '("#dddddd" "#dddddd" "white"))
;;     (fg-alt     '("#bbbbbb" "#bbbbbb" "white"))

;;     (base0      '("#333333" "black"   "black"))
;;     (base1      '("#444444" "#1e1e1e" "brightblack"))
;;     (base2      '("#666666" "#2e2e2e" "brightblack"))
;;     (base3      '("#888888" "#262626" "brightblack"))
;;     (base4      '("#999999" "#3f3f3f" "brightblack"))
;;     (base5      '("#aaaaaa" "#525252" "brightblack"))
;;     (base6      '("#bbbbbb" "#6b6b6b" "brightblack"))
;;     (base7      '("#dddddd" "#979797" "brightblack"))
;;     (base8      '("#eeeeee" "#dfdfdf" "white"))
...
;;   ;;; Faces
;;   ((bold                 :weight 'bold   :foreground (unless doom-themer-enable-bold base8))
;;    (italic               :slant  'italic :foreground (unless doom-themer-enable-italic base5))
;;    (bold-italic          :inherit '(bold italic))
...
;;   ;;  (jdee-db-spec-breakpoint-face-colors ,(cons base0 grey))
;;   ;;  (jdee-db-requested-breakpoint-face-colors ,(cons base0 green))
;;   ;;  (jdee-db-active-breakpoint-face-colors ,(cons base0 highlight))
...
;;
(define-doom-theme
    (doom-base-light :extends doom-base-dark
                     :base t)
  "TODO"
  ((bg "white")
   (bg-alt "white")
  ...
  (;; --- Major modes ------------------------
   ...
   ;; helm
   (helm-selection :inherit 'bold :background selection :distant-foreground base0)
   ;; stripe-buffer
   (stripe-highlight :background base5)
   ;; twittering-mode
   (twitter-divider :underline `(:color ,(doom-lighten border 0.2)))  ; custom face in Doom Emacs
   ))

(provide 'doom-themer-base)
